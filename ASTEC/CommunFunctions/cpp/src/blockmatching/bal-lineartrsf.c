...
static int _LS_Barycenters2DSubroutine( void *parameter,
					size_t first,
					size_t last )
{
...
static int _LS_TranslationScaling2DSubroutine( void *parameter,
					       size_t first,
					       size_t last )
{
...
static int _LS_Rigid2DSubroutine( void *parameter,
				  size_t first,
				  size_t last )
{
...
static int _LS_Similitude2DSubroutine( void *parameter,
				       size_t first,
				       size_t last )
{
  double *sum                  = ((_LinearTrsfAuxiliaryParam*)parameter)->sum;
...
static int _LS_SimilitudeScale2DSubroutine( void *parameter,
					    size_t first,
					    size_t last )
{
...
static int _LS_Affine2DSubroutine( void *parameter,
				   size_t first,
				   size_t last )
{
  double *cov                  = ((_LinearTrsfAuxiliaryParam*)parameter)->cov;
...
static int _LS_Barycenters3DSubroutine( void *parameter,
					size_t first,
					size_t last )
{
  bal_doublePoint *orig_center = &((_LinearTrsfAuxiliaryParam*)parameter)->orig_center;
...
static int _LS_TranslationScaling3DSubroutine( void *parameter,
					       size_t first,
					       size_t last )
{
  double *cov                  = ((_LinearTrsfAuxiliaryParam*)parameter)->cov;
...
static int _LS_Rigid3DSubroutine( void *parameter,
				  size_t first,
				  size_t last )
{
  double *sum                  = ((_LinearTrsfAuxiliaryParam*)parameter)->sum;
...
static int _LS_Similitude3DSubroutine( void *parameter,
				       size_t first,
				       size_t last )
{
  double *sum                  = ((_LinearTrsfAuxiliaryParam*)parameter)->sum;
...
static int _LS_SimilitudeScale3DSubroutine( void *parameter,
					    size_t first,
					    size_t last )
{
  double *similitude_criteria  = &((_LinearTrsfAuxiliaryParam*)parameter)->similitude_criteria;
...
static int _LS_Affine3DSubroutine( void *parameter,
				   size_t first,
				   size_t last )
{
  double *cov                  = ((_LinearTrsfAuxiliaryParam*)parameter)->cov;
...
static int _WLS_Barycenters2DSubroutine( void *parameter,
					 size_t first,
					 size_t last )
{
  bal_doublePoint *orig_center = &((_LinearTrsfAuxiliaryParam*)parameter)->orig_center;
...
static int _WLS_TranslationScaling2DSubroutine( void *parameter,
						size_t first,
						size_t last )
{
  double *cov                  = ((_LinearTrsfAuxiliaryParam*)parameter)->cov;
...
static int _WLS_Rigid2DSubroutine( void *parameter,
				   size_t first,
				   size_t last )
{
  double *sum                  = ((_LinearTrsfAuxiliaryParam*)parameter)->sum;
...
static int _WLS_Similitude2DSubroutine( void *parameter,
					size_t first,
					size_t last )
{
  double *sum                  = ((_LinearTrsfAuxiliaryParam*)parameter)->sum;
...
static int _WLS_SimilitudeScale2DSubroutine( void *parameter,
					     size_t first,
					     size_t last )
{
  double *similitude_criteria  = &((_LinearTrsfAuxiliaryParam*)parameter)->similitude_criteria;
...
static int _WLS_Affine2DSubroutine( void *parameter,
				    size_t first,
				    size_t last )
{
  double *cov                  = ((_LinearTrsfAuxiliaryParam*)parameter)->cov;
...
static int _WLS_Barycenters3DSubroutine( void *parameter,
					 size_t first,
					 size_t last )
{
  bal_doublePoint *orig_center = &((_LinearTrsfAuxiliaryParam*)parameter)->orig_center;
...
static int _WLS_TranslationScaling3DSubroutine( void *parameter,
						size_t first,
						size_t last )
{
  double *cov                  = ((_LinearTrsfAuxiliaryParam*)parameter)->cov;
...
static int _WLS_Rigid3DSubroutine( void *parameter,
				   size_t first,
				   size_t last )
{
  double *sum                  = ((_LinearTrsfAuxiliaryParam*)parameter)->sum;
...
static int _WLS_Similitude3DSubroutine( void *parameter,
					size_t first,
					size_t last )
{
  double *sum                  = ((_LinearTrsfAuxiliaryParam*)parameter)->sum;
...
static int _WLS_SimilitudeScale3DSubroutine( void *parameter,
					     size_t first,
					     size_t last )
{
  double *similitude_criteria  = &((_LinearTrsfAuxiliaryParam*)parameter)->similitude_criteria;
...
static int _WLS_Affine3DSubroutine( void *parameter,
				    size_t first,
				    size_t last )
{
  double *cov                  = ((_LinearTrsfAuxiliaryParam*)parameter)->cov;
...
static int _LinearTrsf_Residuals_2DSubroutine( void *parameter,
					       size_t first,
					       size_t last )
{
  double *mat  = ((_LinearTrsfResidualsParam*)parameter)->theTrsf->mat.m;
  FIELD *field = ((_LinearTrsfResidualsParam*)parameter)->field;
...
static int _LinearTrsf_Residuals_3DSubroutine( void *parameter,
					       size_t first,
					       size_t last )
{
  double *mat  = ((_LinearTrsfResidualsParam*)parameter)->theTrsf->mat.m;
