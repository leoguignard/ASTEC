/*************************************************************************
 * test-gener-ellipse3D.c - test de generation d'ellipses 3D
 *
 * $Id: test-gener-ellipse3D.c,v 1.1 1999/07/26 15:14:17 greg Exp $
 *
 * DESCRIPTION: 
 *
 *
...
#endif
{
  ...
  printf("rayons = (%9.2f %9.2f %9.2f), angle = %9.2f degres\n",
	 radius[0], radius[1], radius[2], angle );
