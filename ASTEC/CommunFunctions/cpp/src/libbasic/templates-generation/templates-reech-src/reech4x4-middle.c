...
static int _Reech3DTriLin4x4_TYPE ( void *parameter,
				    size_t first,
				    size_t last )
{
...
static int _Reech3DTriLin4x4gb_TYPE ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DNearest4x4_TYPE ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4_TYPE ( void *parameter,
				    size_t first,
				    size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4gb_TYPE ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DNearest4x4_TYPE ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
