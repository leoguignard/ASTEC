...
static int _Reech3DTriLin4x4_u8 ( void *parameter,
				    size_t first,
				    size_t last )
{
...
static int _Reech3DTriLin4x4gb_u8 ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DNearest4x4_u8 ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4_u8 ( void *parameter,
				    size_t first,
				    size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4gb_u8 ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DNearest4x4_u8 ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DTriLin4x4_s8 ( void *parameter,
				    size_t first,
				    size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DTriLin4x4gb_s8 ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DNearest4x4_s8 ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4_s8 ( void *parameter,
				    size_t first,
				    size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4gb_s8 ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DNearest4x4_s8 ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DTriLin4x4_u16 ( void *parameter,
				    size_t first,
				    size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DTriLin4x4gb_u16 ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DNearest4x4_u16 ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4_u16 ( void *parameter,
				    size_t first,
				    size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4gb_u16 ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DNearest4x4_u16 ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DTriLin4x4_s16 ( void *parameter,
				    size_t first,
				    size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DTriLin4x4gb_s16 ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DNearest4x4_s16 ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4_s16 ( void *parameter,
				    size_t first,
				    size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4gb_s16 ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DNearest4x4_s16 ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DTriLin4x4_r32 ( void *parameter,
				    size_t first,
				    size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DTriLin4x4gb_r32 ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech3DNearest4x4_r32 ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4_r32 ( void *parameter,
				    size_t first,
				    size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DTriLin4x4gb_r32 ( void *parameter,
				      size_t first,
				      size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
...
static int _Reech2DNearest4x4_r32 ( void *parameter,
				     size_t first,
				     size_t last )
{
  _LinearResamplingParam *p = (_LinearResamplingParam *)parameter;
