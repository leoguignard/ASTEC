...
static int _VT_IDistance( vt_image *resIm, vt_image *theIm, vt_distance *par )
#else
static int _VT_IDistance( resIm, theIm, par )
vt_image *resIm;
vt_image *theIm;
vt_distance *par ;
#endif
...
static int _VT_DCsg( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_DCsg(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_DLs( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_DLs(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_DCsd( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_DCsd(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_DCg( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_DCg(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_DCe( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_DCe(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_DCd( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_DCd(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_DCig( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_DCig(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_DLi( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_DLi(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_DCid( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_DCid(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_RCid( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_RCid(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_RLi( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_RLi(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_RCig( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_RCig(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_RCd( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_RCd(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_RCe( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_RCe(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_RCg( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_RCg(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_RCsd( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_RCsd(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_RLs( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_RLs(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static int _VT_RCsg( u16 *vl, int i, int *offset, vt_distance *par )
#else
static int _VT_RCsg(vl, i, offset, par )
u16 *vl;
int i;
int *offset;
vt_distance *par ;
...
static void _VT_ISeuil( vt_image *resIm, vt_image *theIm, int *offset, vt_distance *par )
#else
static void _VT_ISeuil( resIm, theIm, offset, par )
vt_image *resIm;
vt_image *theIm;
int *offset;
vt_distance *par ;
