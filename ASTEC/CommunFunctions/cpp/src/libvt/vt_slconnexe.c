...
#else
static void _VT_InitNeighbors();
static void _VT_InitList();
static void _VT_FreeList();
static int  _VT_AddPtToList();
static void _VT_InitVList();
static void _VT_FreeVList();
static int  _VT_AddPtToVList();
#endif
...
#else
int VT_SlowConnexe( image, par )
vt_image *image; /* image where the connected components are to be searched */
vt_connexe *par; /* parameters */ 
#endif
{
    ...
    size = (int)( VT_Sqrt( (double)(dx * dy * dz) ) + 1 );
...
#else
int VT_SlowConnexeWithThresholds( image, par, seuils, first_point )
vt_image *image; /* image where the connected components are to be searched */
vt_connexe *par; /* parameters */ 
vt_ipt *seuils;  /* thresholds */
vt_ipt *first_point; /* first point */ 
...
static void _VT_InitNeighbors( vt_ipt *vois_06_18_26, vt_ipt *vois_04_08_10 )
#else
static void _VT_InitNeighbors( vois_06_18_26, vois_04_08_10 )
vt_ipt *vois_06_18_26;
vt_ipt *vois_04_08_10;
#endif
{
    /*--- 06-voisins ---*/
...
static void _VT_InitList( _vt_liste *liste, int size )
#else
static void _VT_InitList( liste, size )
_vt_liste *liste;
int size;
#endif
{
...
static void _VT_FreeList( _vt_liste *liste )
#else
static void _VT_FreeList( liste )
_vt_liste *liste;
#endif
{
    int i;
...
static int _VT_AddPtToList( _vt_liste *liste, int x, int y, int z )
#else
static int _VT_AddPtToList( liste, x, y, z )
_vt_liste *liste;
int x;
int y;
int z;
...
static void _VT_InitVList( _vt_vliste *liste, int size )
#else
static void _VT_InitVList( liste, size )
_vt_vliste *liste;
int size;
#endif
{
...
static void _VT_FreeVList( _vt_vliste *liste )
#else
static void _VT_FreeVList( liste )
_vt_vliste *liste;
#endif
{
    int i;
...
static int _VT_AddPtToVList( _vt_vliste *liste, int x, int y, int z, int v )
#else
static int _VT_AddPtToVList( liste, x, y, z, v )
_vt_vliste *liste;
int x;
int y;
int z;
