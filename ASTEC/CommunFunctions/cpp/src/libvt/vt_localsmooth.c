...
#else
int VT_06LocalSmoothing( theIm, resIm, iterations )
vt_image *theIm;
vt_image *resIm;
int iterations;
#endif
...
#else
int VT_26LocalSmoothing( theIm, resIm, iterations )
vt_image *theIm;
vt_image *resIm;
int iterations;
#endif
...
#else
int VT_SmoothingWithConnectivity( theIm, resIm, conn, iterations )
vt_image *theIm;
vt_image *resIm;
Neighborhood conn;
int iterations;
...
#else
static int _Operation_Uchar( theIm, resIm, conn, iterations )
vt_image *theIm;
vt_image *resIm;
Neighborhood conn;
int iterations;
...
#else
static int _Operation_Schar( theIm, resIm, conn, iterations )
vt_image *theIm;
vt_image *resIm;
Neighborhood conn;
int iterations;
...
#else
static int _Operation_Ushort( theIm, resIm, conn, iterations )
vt_image *theIm;
vt_image *resIm;
Neighborhood conn;
int iterations;
...
#else
static int _Operation_Sshort( theIm, resIm, conn, iterations )
vt_image *theIm;
vt_image *resIm;
Neighborhood conn;
int iterations;
...
#else
static int _Operation_Int( theIm, resIm, conn, iterations )
vt_image *theIm;
vt_image *resIm;
Neighborhood conn;
int iterations;
...
#else
static int _Operation_Float( theIm, resIm, conn, iterations )
vt_image *theIm;
vt_image *resIm;
Neighborhood conn;
int iterations;
