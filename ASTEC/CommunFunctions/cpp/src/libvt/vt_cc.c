...
#else
static void _VT_MarqueVoisins_1();
static void _VT_MarqueVoisins_2();
#endif
...
#else
int _VT_26CCin27V( voisins )
int voisins[27]; /* neighborhood to be examinated */
#endif
{
	int marque[27];
	register int i, nbCC;
...
#else
int _VT_26CCin26VisOne( voisins )
int voisins[27]; /* neighborhood to be examinated */
#endif
{
	int marque[27];
...
#else
int _VT_06CCin18VisOne( voisins )
int voisins[27]; /* neighborhood to be examinated */
#endif
{
	int marque[27];
...
static void _VT_MarqueVoisins_1( int v[27], 
			      ...
			      int nb )
#else
static void _VT_MarqueVoisins_1( v, m, R, i, nb )
int v[27];
int m[27];
int R[27][27];
int i;
...
static void _VT_MarqueVoisins_2( int v[27], 
			      ...
			      int nb )
#else
static void _VT_MarqueVoisins_2( v, m, R, i, nb )
int v[27];
int m[27];
int R[27][27];
int i;
