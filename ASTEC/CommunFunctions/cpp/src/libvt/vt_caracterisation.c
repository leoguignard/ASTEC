...
#else
static int _VT_CaracterisationComplete();
static int _VT_CCin5x5x5Neighborhood();
#endif

#ifndef NO_PROTO
void VT_InitCaracterisation( vt_caracterisation *par /* characterization parameters */ )
#else
void VT_InitCaracterisation( par )
vt_caracterisation *par;
#endif
{
...
#else
int VT_Caracterisation( im1, im2, par )
vt_image *im1;           /* image result */
vt_image *im2;           /* image to be topologically characterized */
vt_caracterisation *par; /* characterization parameters */
#endif
{  
    ...
    for ( y = 0; y < im2->dim.y; y++ )
    for ( x = 0; x < im2->dim.x; x++ ) {
...
int VT_CaracterisationComplete( vt_image *im1 /* image result */,
			...
			vt_caracterisation *par /* characterization parameters */ )
#else
int VT_CaracterisationComplete( im1, im2, par )
vt_image *im1;               /* image result */
vt_image *im2;               /* image to be topologically characterized */
vt_caracterisation *par; /* characterization parameters */
#endif
...
static int _VT_CaracterisationComplete( vt_image *im1 /* image result */,
			...
			vt_caracterisation *par /* characterization parameters */ )
#else
static int _VT_CaracterisationComplete( im1, im2, par )
vt_image *im1;               /* image result */
vt_image *im2;               /* image to be topologically characterized */
vt_caracterisation *par; /* characterization parameters */
#endif
...
int VT_CaracterisationCurves( vt_image *im1 /* image result */,
			      vt_image *im2 /* image to be topologically characterized */ )
#else
int VT_CaracterisationCurves( im1, im2 )
vt_image *im1; /* image result */
vt_image *im2; /* image to be topologically characterized */
#endif
{
...
static int _VT_CCin5x5x5Neighborhood( int *vois )
#else
static int _VT_CCin5x5x5Neighborhood( vois )
int *vois;
#endif
{
