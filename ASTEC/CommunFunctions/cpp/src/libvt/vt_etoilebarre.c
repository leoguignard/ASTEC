...
#else 
static void _VT_CetoileEquivalence();
static void _VT_CbarreEquivalence();
#endif
...
static void _VT_CetoileEquivalence( int labels[8], int l, int i )
#else
static void _VT_CetoileEquivalence( labels, l, i )
int labels[8];
int l;
int i;
#endif
...
static void _VT_CbarreEquivalence( int labels[27], int l, int i )
#else
static void _VT_CbarreEquivalence( labels, l, i )
int labels[27];
int l;
int i;
#endif
