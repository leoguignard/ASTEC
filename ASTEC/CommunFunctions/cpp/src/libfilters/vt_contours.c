...
int act2D_readStructure( typeStructure *s, FILE *f )
{
...
int act3D_readStructure( typeStructure *s, FILE *f )
{
...
int act2D_writeStructure( typeStructure *structure, FILE *f )
{
...
int matlab_writeStructure( typeStructure *s, char *filename )
{
