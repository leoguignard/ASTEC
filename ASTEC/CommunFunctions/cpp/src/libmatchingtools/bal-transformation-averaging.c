...
static int LS_Translation_Scaling_2D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
...
static int LS_Translation_Scaling_3D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
  char *proc = "LS_Translation_Scaling_2D_Average";
  BAL_SetTransformationToIdentity( resTrsf );
...
static int LS_Rigid_2D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
...
static int LS_Rigid_3D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
  char *proc = "LS_Rigid_3D_Average";
  BAL_SetTransformationToIdentity( resTrsf );
...
static int LS_Similitude_2D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
...
static int LS_Similitude_3D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
...
static int WLS_Translation_Scaling_2D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
...
static int WLS_Translation_Scaling_3D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
  char *proc = "WLS_Translation_Scaling_2D_Average";
  BAL_SetTransformationToIdentity( resTrsf );
...
static int WLS_Rigid_2D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
...
static int WLS_Rigid_3D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
  char *proc = "WLS_Rigid_3D_Average";
  BAL_SetTransformationToIdentity( resTrsf );
...
static int WLS_Similitude_2D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
...
static int WLS_Similitude_3D_Average( bal_transformationList *listTrsf,
					      bal_transformation *resTrsf )
{
				       ...
				       bal_estimator *estimator )
{
  ...
  if ( estimator->standard_deviation_threshold > 0.0 ) {
    ...
    m = s = 0.0;
    for ( m=0.0, i=0; i<listTrsf->n_trsfs; i++ )
      m += listTrsf->pointer[i]->error;
    m /= listTrsf->n_trsfs;
    for ( s=0.0, i=0; i<listTrsf->n_trsfs; i++ )
...
int BAL_ComputeMultipleTransformations( bal_transformationArray *theTrsfs,
					...
					int useinverse )
{
  char *proc = "BAL_ComputeMultipleTransformations";
  ...
  for ( iteration=0; iteration<n_iterations; iteration++ ) {
    ...
    /*  transformation estimation
       ...
       the next estimation of  T_{ ref <- i } is the average 
