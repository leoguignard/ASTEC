...
extern int VT_ComputeLabelBarycentres(vt_image labels, vt_image_barycentres* b);

extern int VT_NCell(vt_image img);
...
extern int VT_AllocImageBarycentresWithImage(vt_image_barycentres* b, vt_image labels);
