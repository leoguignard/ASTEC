...
#else
extern void VT_Line();
extern int  VT_ExtractMaxima3D();
extern int  VT_ExtractMaxRad3D();
extern int  VT_ExtractMaxima2D();
extern int  VT_ExtractMaxRad2D();
extern int  VT_Reconstruct2D();
extern int  VT_GreyReconstruct2D();
extern void VT_InitRes();
extern int  VT_AllocRes();
extern void VT_FreeRes();
extern void VT_InitImages();
extern int  VT_AllocImages();
extern void VT_FreeImages();
#endif /* NO_PROTO */
