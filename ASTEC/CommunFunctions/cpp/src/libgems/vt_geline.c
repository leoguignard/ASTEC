...
#else
int VT_ExtractMaxRad3D( res, ims, par )
vt_resline *res;
vt_images *ims;
vt_line *par;
#endif
...
#else
int VT_ExtractMaxRad2D( res, ims, par )
vt_resline *res;
vt_images *ims;
vt_line *par;
#endif
...
#else
int VT_Reconstruct2D( ext, scl, par )
vt_image *ext;
vt_image *scl;
vt_line *par;
#endif
...
static int VT_AllocImages2D( vt_images *par, vt_image *im )
#else
static int VT_AllocImages2D( par, im )
vt_images *par;
vt_image *im;
#endif
{
