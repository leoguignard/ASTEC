...
int main( int argc, char *argv[] )
{
    ...
    printf(" c2 = %12d (after 1st treatment of all neighborhoods)\n", clock_2 );
    printf(" c3 = %12d (after 2nd treatment of all neighborhoods)\n", clock_3 );
    printf(" Total time for neighborhoods' management,    c1-c0 = %d clock ticks\n", 
	   clock_1 - clock_0 );
    printf("                                                    = %g microsecs\n\n", 
	   (clock_1 - clock_0) * clocks_to_microsecs );
    
    printf(" both T06 and T26\n");
