# 1 "../libvt/vt_t06noopt.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../libvt/vt_t06noopt.c"

# 1 "../libvt/vt_t06noopt.h" 1
# 27 "../libvt/vt_t06noopt.h"
extern int Compute_NotOptT06( int neighbors[27] );
# 3 "../libvt/vt_t06noopt.c" 2
